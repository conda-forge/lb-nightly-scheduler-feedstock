...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lb-nightly-scheduler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14583&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lb-nightly-scheduler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lb-nightly-scheduler` can be installed with:

```
conda install lb-nightly-scheduler
```

It is possible to list all of the versions of `lb-nightly-scheduler` available on your platform with:
